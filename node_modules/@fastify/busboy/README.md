    ...
    * The constructor takes the following valid `config` settings:
        ...
        * **isPartAFile** - __function__ - Use this function to override the default file detection
          functionality. It has following parameters:
            ...
            * contentType - __string__ The content-type of the part, e.g. `text/plain`, `image/jpeg`
        ...
        * **limits** - _object_ - Various limits on incoming data. Valid properties are:
            ...
            * **headerSize** - _integer_ - For multipart forms, the max size of a multipart
              header **Default:** 81920.
